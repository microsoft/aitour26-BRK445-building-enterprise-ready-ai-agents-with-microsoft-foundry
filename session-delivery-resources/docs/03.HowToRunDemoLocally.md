...
Demo 2 runs multiple agents in coordination. Expect comparable or longer wall-clock time than Demo 1 since multiple agents each make their own LLM calls. Plan the talk track to keep the audience engaged while the orchestration completes.
