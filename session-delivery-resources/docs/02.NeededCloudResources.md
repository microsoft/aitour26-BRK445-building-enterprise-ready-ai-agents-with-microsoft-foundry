...
- Create a Microsoft Foundry project for the demo
...
**Important**: This authentication step is required because the console application uses `DefaultAzureCredential`, which relies on your Azure CLI authentication to access your Microsoft Foundry project.
...
**Navigation:** [⬅ Previous: Installation](./01.Installation.md) | [🏠 Session Delivery Resources](../readme.md) | [Next: How to Run Demo Locally ➡](./03.HowToRunDemoLocally.md)
